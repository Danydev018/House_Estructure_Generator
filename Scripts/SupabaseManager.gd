...
const SUPABASE_URL = "https://ongmadyqizjtmlwuozbe.supabase.co"
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9uZ21hZHlxaXpqdG1sd3VvemJlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTE4MzY0MTAsImV4cCI6MjA2NzQxMjQxMH0.OrkY5roKjKRfzbsy2rszwp1WUvMGVJBqv9Dm2G7iZvk"
const BUCKET_NAME = "maketalo-data"
